    ...
    <div class="container wider-container">
        ...
        <div id="simulation" class="tab-content card-glass" style="display:none;">
            ...
            <div id="sim-active-area" style="display:none;">
                <!-- Fixed: Full Screen button moved properly into the HTML string structure -->
                <div style="text-align:right; margin-bottom:10px;">
                    <button class="sub-btn" style="width:auto; padding:10px 20px;" onclick="toggleFullScreen()">⛶ Full Screen</button>
                </div>
