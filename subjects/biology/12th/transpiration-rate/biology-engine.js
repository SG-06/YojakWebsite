    ...
    <div class="container wider-container">
        ...
        <div id="procedure" class="tab-content card-glass" style="display:none;">
            ...
            <div class="info-segment" style="margin-top:20px;">
                <h3 class="gradient-text">Steps to Follow</h3>
        ...
        <div id="simulation" class="tab-content card-glass" style="display:none;">
            <div id="sim-launcher" class="sim-launcher">
                <div class="launcher-content">
                    ...
                    <h2 class="gradient-text">Plant Physiology Workbench</h2>
                    <p>Ready to observe transpiration rates under variable environmental conditions?</p>
        ...
        <div id="quiz" class="tab-content card-glass" style="display:none;">
            <h2 class="gradient-text">Knowledge Check</h2>
            <div id="quiz-container"></div>
            <button class="submit-btn" onclick="checkQuiz()">Submit Assessment</button>
...
function checkQuiz() {
    ...
    res.innerHTML = `
        <div class="result-card">
            <h3>Final Score: ${score} / ${part.questions.length}</h3>
            <p>${score >= 7 ? "Excellent! You have a strong grasp of transpiration." : "Review the theory and try again to improve your score."}</p>
        </div>
    `;
